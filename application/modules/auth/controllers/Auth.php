...
class Auth extends MX_Controller {
	...
	public function users()
	{
		...
		elseif (!$this->ion_auth->in_group(1)) // remove this elseif if you want to enable this for non-admins
		{
			// redirect them to the home page because they must be an administrator to view this
			return show_error('You must be an administrator to view this page.');
		}
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$data['subview'] = 'auth/forgot_password';
			$this->template->public_template($data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				$data['subview'] = 'auth/reset_password';
				$this->template->public_template($data);
			}
			else
			{
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->_render_page(base_url().'auth/deactivate_user', $data);
		}
		else
		{
